        ...
        >
          <div className="inline-flex items-center gap-3 px-6 py-3 bg-windy-dark border border-windy-amber/20 rounded-xl">
            ...
            <div className="text-left">
              ...
              <p className="text-xs text-gray-500">3,500+ specialized models • B2B API available • <a href="https://windytranslate.com" className="text-windy-amber/70 hover:text-windy-amber">windytranslate.com</a></p>
            </div>
          </div>
        </motion.div>
